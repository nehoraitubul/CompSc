package Semester2.ProgrammingWorkshop.Lesson4.ImageManipulation.desLines;
...
public class Main {
    ...
    public static void main(String[] args) {
        double num = 3f;
        try {
            File file = new File("src/main/java/Semester2/ProgrammingWorkshop/Lesson4/ImageManipulation/desLines/cake.jpg");
            if (file.exists()){
                Color color;
                ...
                for (int i = 0; i < image.getWidth() - 1; i++) {
                    ...
                    File output = new File("src/main/java/Semester2/ProgrammingWorkshop/Lesson4/ImageManipulation/desLines/newCake.jpg");
